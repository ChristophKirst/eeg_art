...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 11.0, 336.087328851222992, 48.0, 136.0 ],
...
, 			{
				"box" : 				{
					...
					"data" : 					{
						"clips" : [ 							{
								"absolutepath" : "Macintosh HD:/Users/ermulabs/Desktop/STUDENTS/Max_Tutorials/MilesDavis.mp3",
								"filename" : "MilesDavis.mp3",
								"filekind" : "audiofile",
								"id" : "u454004748",
								"loop" : 0,
								"content_state" : 								{
...
,
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 47.0, 239.0, 150.0, 30.0 ],
					"pitchcorrection" : 0,
					"quality" : "basic",
					"saved_attribute_attributes" : 					{
						"candicane2" : 						{
...
,
					"patching_rect" : [ 293.0, 595.416694581508636, 196.611132502555847, 22.0 ],
					"text" : "jit.gen"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 224.0, 223.288032472133636, 86.0, 22.0 ],
					"text" : "t b b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 587.437977731227875, 414.409911274909973, 114.0, 22.0 ],
					"text" : "jit.matrix spectrumA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 587.437977731227875, 300.969046056270599, 114.0, 22.0 ],
					"text" : "jit.matrix spectrumA"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 293.305566251277924, 476.0, 488.0, 22.0 ],
					"text" : "jit.matrix spectrumA 3 float32 250 256 @usedstdim 1 @dstdimstart 0 0 @dstdimend 0 255"
				}
...
, 			{
				"name" : "MilesDavis.mp3",
				"bootpath" : "~/Desktop/STUDENTS/Max_Tutorials",
				"patcherrelativepath" : "../STUDENTS/Max_Tutorials",
				"type" : "Mp3",
				"implicit" : 1
			}
 ],
